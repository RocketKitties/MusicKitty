...
<div class="content">
	...
	<div class="section">
		<div class="row">
			<div class="col-sm-6">
				<h2><i class="fa fa-volume-up"></i>Plays Multiple Music Formats</h2>
				<p><%= application.name %> can play music in different formats:</p>
				<ul>
					<li><b>MP3</b> files - for efficient music storage.</li>
					<li><b>WAV</b> files - for accurate, lossless compression.</li>
				</ul>
			</div>
			<div class="col-sm-6">
				<div class="icon-grid figure">
					<div class="directory item">
						...
						<div class="row">
							<div class="name">MP3 File</div>
						</div>
					</div>
					<div class="directory item">
						<div class="row">
							<div class="icon"><img src="images/icons/files/wav.svg" /></div>
						</div>
						<div class="row">
							<div class="name">WAV File</div>
						</div>
					</div>
				</div>
			</div>
	...
	<div class="section">
		<div class="row">
			<div class="col-sm-6">
				<h2><i class="fa fa-share"></i>Music Sharing</h2>
				<p>Share your music in a variety of ways. </p>
				<ul>
